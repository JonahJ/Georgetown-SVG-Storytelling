...
/***/ function(module, exports, __webpack_require__) {
	...
	var _canvasMap = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imageLoader = __webpack_require__(193);

	var _createCanvas = __webpack_require__(194);
	...
	var _gsap = __webpack_require__(199);
...
/***/ function(module, exports) {
	...
	function objNum(op, obj, num) {
	  ...
	  return (_Object = Object).assign.apply(_Object, [{}].concat(_toConsumableArray(Object.keys(obj).map(function (i) {
	    var r = {};
	    r[i] = op(obj[i], num);
	    return r;
	  }))));
	...
	function objObj(op, objA, objB) {
	  ...
	  return (_Object2 = Object).assign.apply(_Object2, [{}].concat(_toConsumableArray(keysA.map(function (i) {
	    var r = {};
					...
					this.check = function(init) {
						...
						if (missing === 0 && func) {
							...
							if (global) {
								...
								if (!hasModule && "function" === "function" && __webpack_require__(200)){ //AMD
