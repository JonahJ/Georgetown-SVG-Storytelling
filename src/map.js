    ...
    Layer.prototype.processMouseOver = function(e, latlng, pos, data, subLayerIndex) {
        ...
        for (var variable_name in data.content) {
            ...
            if (variable_name == 'campus') {
                 ...
                 * link description...
                 */
                if(variable_content.toLowerCase() in descriptions_by_account_name){
                    var expanded_content = descriptions_by_account_name[variable_content.toLowerCase()];
                    ...
                    self.learn_info.name = self.learn_info.parent
                        .append('h1')
                        .attr('id', 'learn-program')
                        .text(expanded_content['Parent Program']);
